  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/monthly_subscription_for_company_users/subscription/add" method="POST">
...
<div class="row">
	<input type="hidden" value="<?php echo API_DOMAIN; ?>api/monthly_subscription_for_company_users/subscription_list" id="list_end_point">
    <input type="hidden" value="<?php echo API_DOMAIN; ?>api/monthly_subscription_for_company_users/subscription/" id="delete_end_point">
    <input type="hidden" value="<?php echo API_DOMAIN; ?>api/monthly_subscription_for_company_users/subscription_details" id="show_endpoint">
    <input type="hidden" value="admin/master/subscription_edit" id="edit_page_name">
