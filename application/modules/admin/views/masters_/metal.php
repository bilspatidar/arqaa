  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/metal/metal/add" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <div class="col-sm-12">
                  <label class="col-form-label">Metal Name</label>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <div class="col-sm-12">
                  <label class="col-form-label">Metal Price</label>
                  <input type="number" class="form-control" name="metal_price"/>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group row">
                <div class="col-sm-12">
                  <label class="col-form-label">metal_unit_id</label>
                  <input type="number" class="form-control" name="metal_unit_id"/>
                </div>
              </div>
            </div>
...
<div class="row">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/metal/metal_list" id="list_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/metal/metal/" id="delete_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/metal/metal_details" id="show_endpoint">
  <input type="hidden" value="admin/master/metal_edit" id="edit_page_name">
