        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="card-wrapper flip-left">
                                <div class="card s-widget-top">
                                    ...
                                    <div class="back p-3 px-4 bg-green text-center">
                                        <p class="text-light">This Week</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div id="chart-pie" style="height: 275px"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
            ...
            <div class="row clearfix">
                <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2>Users<small>From the last month</small></h2>
                        </div>
                        <div class="body">
                            <div class="row text-center">
                                <div class="col-lg-12 col-md-5">
                                    <div class="text-center">
                                        <input type="text" class="knob" value="77" data-width="120" data-height="120" data-thickness="0.3" data-bgColor="#383b40" data-fgColor="#17C2D7">
                                    </div>
                                ...
                                <div class="col-lg-12 col-md-5">
                                    <div class="text-center">
                                        <input type="text" class="knob" value="38" data-width="110" data-height="110" data-thickness="0.3" data-bgColor="#383b40" data-fgColor="#dc3545">
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-custom spacing8">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="w60">
                                        <div class="avtar-pic w35 bg-indigo" data-toggle="tooltip" data-placement="top" title="Avatar Name"><span>KG</span></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="w60">
                                        <div class="avtar-pic w35 bg-pink" data-toggle="tooltip" data-placement="top" title="Avatar Name"><span>KG</span></div>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" title="">Project 6</a>
                                        <p class="mb-0">Mike</p>
                                    </td>                                    
                                    <td>
                                        <span>Lorem is simply dummy text of the printing and typesetting industry.</span>
