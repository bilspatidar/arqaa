...
<form id="crudFormUpdateApiData" action="<?php echo API_DOMAIN; ?>api/regular_user_monthly_subscription/regular_user_monthly_subscription/update"  method="POST" class="row g-3">
