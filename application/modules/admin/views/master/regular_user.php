  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/regular_user/regular_user/add" method="POST">
...
<div class="row">
  ...
  <input type="hidden" value="admin/master/regular_user_edit" id="edit_page_name">
