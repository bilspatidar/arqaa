...
.profile .profile-edit img {
  max-width: 120px;
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link ml-2" data-bs-toggle="tab" data-bs-target="#profile-edit">Edit Profile</button>
                </li>

                <li class="nav-item">
                  <button class="nav-link ml-2" data-bs-toggle="tab" data-bs-target="#profile-settings">Settings</button>
                </li>

                <li class="nav-item">
                  <button class="nav-link ml-2" data-bs-toggle="tab" data-bs-target="#profile-change-password">Change Password</button>
                </li>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          <a href="#" class="btn btn-primary btn-sm" title="Upload new profile image"><i class=" icon-arrow-up"></i></a>
                          <a href="#" class="btn btn-danger btn-sm" title="Remove my profile image"><i class="fa fa-trash-o"></i></a>
                        </div>
                      </div>
                    </div>
    ...
    <script>
  // JavaScript to activate tabs using Bootstrap 5
  document.addEventListener('DOMContentLoaded', function () {
    var tabEl = document.querySelectorAll('.nav-link');

    tabEl.forEach(function (tab) {
      tab.addEventListener('click', function () {
        // Ensure the previously active tab is deactivated
        ...
        // Show the content section of the clicked tab
