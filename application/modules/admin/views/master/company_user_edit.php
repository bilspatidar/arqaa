...
<form id="crudFormUpdateApiData" action="<?php echo API_DOMAIN; ?>api/company_user/company_user/update"  method="POST" class="row g-3">
	...
	<div class="col-md-12 form-group">
		<label class="col-form-label"><?php echo $this->lang->line('paternal_surname');?></label>
         <input type="text" class="form-control" name="paternal_surname" value="<?php echo $data['paternal_surname']; ?>" />
	</div>
	<div class="col-md-12 form-group">
		<label class="col-form-label"><?php echo $this->lang->line('maternal_surname');?></label>
         <input type="text" class="form-control" name="maternal_surname" value="<?php echo $data['maternal_surname']; ?>" />
	</div>
	<div class="col-md-12 form-group">
	...
	<div class="col-md-12 form-group">
            ...
            <div class="form-control d-flex align-items-center justify-content-between">
                ...
                <output id="spinValueModal" role="spinbutton" aria-valuenow="2" class="mx-2"><?php echo $data['radio']; ?></output>
                <input type="hidden" name="radio" id="value_of_spin_modal" role="spinbutton" aria-valuenow="2" class="mx-2" value="<?php echo $data['radio']; ?>">
...
<script>
    let currentValueModal = 2; // Initial value

    function updateOutputModal() {
        document.getElementById('spinValueModal').textContent = currentValueModal;
		$("#value_of_spin_modal").val(currentValueModal);
    }

    function increment() {
        if (currentValueModal < 1000) {
            currentValueModal++;
            updateOutputModal();
        }
    }
