  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/cv/cv/add" method="POST">
...
<div class="row">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/cv/cv_list" id="list_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/cv/cv/" id="delete_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/cv/cv_details" id="show_endpoint">
