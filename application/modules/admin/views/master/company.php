        ...
        <table class="table table-hover js-basic-example dataTable table-custom spacing5 " id="api_response_table">
            ...
            <thead>
              <tr>
                ...
                <th><?php echo $this->lang->line('business_email');?></th>
                <th><?php echo $this->lang->line('special_services');?></th>
                <th><?php echo $this->lang->line('company_size');?></th>
...
<script>
  function renderTableData(){
    return [
      ...
      { "data": "business_email", "orderable": true },
      { "data": "special_services", "orderable": true },
      { "data": "company_size", "orderable": true },
      {
        "data": "status",
        "orderable": true,
