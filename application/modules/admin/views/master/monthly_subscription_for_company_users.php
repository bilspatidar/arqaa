  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/monthly_subscription_for_company_users/monthly_subscription_for_company_users/add" method="POST">
...
<div class="row">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/monthly_subscription_for_company_users/monthly_subscription_for_company_users_list" id="list_end_point">
    <input type="hidden" value="<?php echo API_DOMAIN; ?>api/monthly_subscription_for_company_users/monthly_subscription_for_company_users/" id="delete_end_point">
    <input type="hidden" value="<?php echo API_DOMAIN; ?>api/monthly_subscription_for_company_users/monthly_subscription_for_company_users_details" id="show_endpoint">
  <input type="hidden" value="admin/master/monthly_subscription_for_company_users_edit" id="edit_page_name">
