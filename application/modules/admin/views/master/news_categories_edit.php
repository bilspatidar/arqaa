	<div class="modal_title_details"><h4><?php echo $this->lang->line('edit_news_categories');?></h4></div>
<form id="crudFormUpdateApiData" action="<?php echo API_DOMAIN; ?>api/news_categories/news_categories/update"  method="POST" class="row g-3">
