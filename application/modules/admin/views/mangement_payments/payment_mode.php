  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/payment_mode/payment_mode/add" method="POST">
...
<div class="row">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/payment_mode/payment_mode_list" id="list_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/payment_mode/payment_mode/" id="delete_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/payment_mode/payment_mode_details" id="show_endpoint">
  <input type="hidden" value="admin/mangement_payments/payment_mode_edit" id="edit_page_name">
