  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/services/services/add" method="POST">
...
<div class="row">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/services/services_list" id="list_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/services/services/" id="delete_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/services/services_details" id="show_endpoint">
  <input type="hidden" value="admin/manage_web/services_edit" id="edit_page_name">
