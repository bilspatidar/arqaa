  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/blog/blog/add" method="POST">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <option value="<?php echo $blog_category->id;?>"><?php echo $blog_category->name;?></option>
                  <?php } ?>
</select>
                </div>
              </div>
...
<div class="row">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/blog/blog_list" id="list_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/blog/blog/" id="delete_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/blog/blog_details" id="show_endpoint">
  <input type="hidden" value="admin/manage_web/blogs_edit" id="edit_page_name">
