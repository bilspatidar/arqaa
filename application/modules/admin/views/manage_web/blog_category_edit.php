<div class="modal_title_details"><h4>Edit Blog Category</h4></div>
<form id="crudFormUpdateApiData" action="<?php echo API_DOMAIN; ?>api/blog_category/blog_category/update" method="POST" class="row g-3">
