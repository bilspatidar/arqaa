  ...
  <div class="col-12 grid-margin collapse show" id="collapseExample">
    <div class="card">
      <div class="card-body">
        ...
        <form class="form-sample" id="crudFormAddApiData" action="<?php echo API_DOMAIN; ?>api/country_state_city/country_list/add" method="POST">
...
<div class="row">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/country_state_city/country_list" id="list_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/country_state_city/country_list/" id="delete_end_point">
  <input type="hidden" value="<?php echo API_DOMAIN; ?>api/country_state_city/country_details" id="show_endpoint">
